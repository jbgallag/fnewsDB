...
print "<table>"
print "<tr>"
print "<form action=\"http://localhost/cgi-bin/fnewsInsertMain.py\" method=\"post\" target=\"queryDisplay\">"
...
print "<table>"
print "<tr>"
print "<form action=\"http://localhost/cgi-bin/fnewsQueryMain.py\" method=\"post\" target=\"queryDisplay\">"
print "<td>Article Title:<br>"
...
print "<table>"
print "<form action=\"http://localhost/cgi-bin/fnewsGraphMain.py\" method=\"post\" target=\"graphDisplay\">"
